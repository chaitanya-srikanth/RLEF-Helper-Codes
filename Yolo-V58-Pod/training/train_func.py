...
class training_function():
    ...
    def train(self):
        ...
        if Config.PROJECT_TYPE == "detection" or Config.PROJECT_TYPE == "segmentation":
            ...
            csv_to_json_convert(self.train_csv_path, self.train_json_path, self.parent_dir, Config.single_cls)
            csv_to_json_convert(self.test_csv_path, self.test_json_path, self.test_parent_dir, Config.single_cls)

            json_to_txt_convert(self.train_json_path, self.model_details['_id'], self.parent_dir, Config.PROJECT_TYPE, Config.single_cls)
            json_to_txt_convert(self.test_json_path, self.model_details['_id'], self.test_parent_dir,
                                Config.PROJECT_TYPE, Config.single_cls)
