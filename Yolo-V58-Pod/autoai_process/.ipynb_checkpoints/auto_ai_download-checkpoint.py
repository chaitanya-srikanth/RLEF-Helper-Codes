...
def csv_to_json_convert(csv_file, json_file_name, dataset_dir):
    input_csv = csv_file
    ...
    for index, row in (df.iterrows()):
        ...
        for object in objects:
            ...
            try:
                ...
                #print("object----> ", object)
                label = object['selectedOptions'][1]['value'] if "selectedOptions" in object.keys() and isinstance(object['selectedOptions'], list) and object['selectedOptions'] else "pair"
